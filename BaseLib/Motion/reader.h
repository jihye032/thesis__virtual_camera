...
namespace ml {
	...
	{
	public:
		void LoadBVH(const char *file, Motion *motion, bool human_load=true, double scale=1.0, int sample = 1);
	...
	bool LoadBVH(const char *file, Motion *out_motion, bool human_load=true, double scale=1.0, int sample=1);
